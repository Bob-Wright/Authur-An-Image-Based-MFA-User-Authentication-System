...
<!--Main Navigation-->
<header id="anchor1" class="container">
  <nav style="background:#b0a2ff;" class="row navbar">
    <div class="col-1" >
      <a id="navbarContent" href="https://syntheticreality.net/Storybook/controllers/logout.php" class="navbar-brand" title="return to Login Portal">
        ...
        <div class="col-2" style="color: blue;font-size: 2vw;"><b>Synthetic Reality Storybook</b></div>
      <h1 style="color: black;" class="col-7 font-weight-bolder">Select your gatekeeper</h1>
    </nav>
</header>
...
echo '<div class="container flex-col col-11">'.
	'<form action="./mugshot.php" method="post" enctype="text">'.
    '<input hidden type="text" name="userEmail" value="'.$_SESSION["email"].'"></input>'.
  '<div class="form-group">';
echo '<div class="row d-flex justify-content-center">'.
'<button tabindex="0" class="col-3 gallery" type="submit" name="imageName" value="tile=1&mug='.$displayFiles[0].'&token='.$diceOrder[0].'&dice=' . $diceImages[0][0] . $diceImages[0][1] . $diceImages[0][2] . '"><img src="./ckimages/'.$displayFiles[0].'.jpg" width="100%" height="auto" alt="' .$displayList[0].'"></button>'.
'<button tabindex="0" class="col-3 gallery" type="submit" name="imageName" value="tile=2&mug='.$displayFiles[1].'&token='.$diceOrder[1].'&dice=' . $diceImages[1][0] . $diceImages[1][1] . $diceImages[1][2] . '"><img src="./ckimages/'.$displayFiles[1].'.jpg" width="100%" height="auto" alt="' .$displayList[1].'"></button>'.
'<button tabindex="0" class="col-3 gallery" type="submit" name="imageName" value="tile=3&mug='.$displayFiles[2].'&token='.$diceOrder[2].'&dice=' . $diceImages[2][0] . $diceImages[2][1] . $diceImages[2][2] . '"><img src="./ckimages/'.$displayFiles[2].'.jpg" width="100%" height="auto" alt="' .$displayList[2].'"></button>'.
'<button tabindex="0" class="col-3 gallery" type="submit" name="imageName" value="tile=4&mug='.$displayFiles[3].'&token='.$diceOrder[3].'&dice=' . $diceImages[3][0] . $diceImages[3][1] . $diceImages[3][2] . '"><img src="./ckimages/'.$displayFiles[3].'.jpg" width="100%" height="auto" alt="' .$displayList[3].'"></button>'.
'</div>'.
...
echo '<div class="row d-flex justify-content-center">'.
'<button tabindex="0" class="col-3 gallery" type="submit" name="imageName" value="tile=5&mug='.$displayFiles[4].'&token='.$diceOrder[4].'&dice=' . $diceImages[4][0] . $diceImages[4][1] . $diceImages[4][2] . '"><img src="./ckimages/'.$displayFiles[4].'.jpg" width="100%" height="auto" alt="' .$displayList[4].'"></button>'.
'<button tabindex="0" class="col-3 gallery" type="submit" name="imageName" value="tile=6&mug='.$displayFiles[5].'&token='.$diceOrder[5].'&dice=' . $diceImages[5][0] . $diceImages[5][1] . $diceImages[5][2] . '"><img src="./ckimages/'.$displayFiles[5].'.jpg" width="100%" height="auto" alt="' .$displayList[5].'"></button>'.
'<button tabindex="0" class="col" href="/mugshot.php?tile=7&mug='.$displayFiles[6].'&token='.$diceOrder[6]. '&dice=' . $diceImages[6][0] . $diceImages[6][1] . $diceImages[6][2] . '"><img src="./ckimages/'.$displayFiles[6].'.jpg" width="100%" height="auto" alt="' .$displayList[6].'"></button>'.
'<button tabindex="0" class="col-3 gallery" type="submit" name="imageName" value="tile=8&mug='.$displayFiles[7].'&token='.$diceOrder[7].'&dice=' . $diceImages[7][0] . $diceImages[7][1] . $diceImages[7][2] . '"><img src="./ckimages/'.$displayFiles[7].'.jpg" width="100%" height="auto" alt="' .$displayList[7].'"></button>'.
'</div>'.
...
// display the next 4 entries from the imageOrder shuffle
echo '<div class="row d-flex justify-content-center">'.
'<button tabindex="0" class="col-3 gallery" type="submit" name="imageName" value="tile=9&mug='.$displayFiles[8].'&token='.$diceOrder[8].'&dice=' . $diceImages[8][0] . $diceImages[8][1] . $diceImages[8][2] . '"><img src="./ckimages/'.$displayFiles[8].'.jpg" width="100%" height="auto" alt="' .$displayList[8].'"></button>'.
'<button tabindex="0" class="col-3 gallery" type="submit" name="imageName" value="tile=10&mug='.$displayFiles[9].'&token='.$diceOrder[9].'&dice=' . $diceImages[9][0] . $diceImages[9][1] . $diceImages[9][2] . '"><img src="./ckimages/'.$displayFiles[9].'.jpg" width="100%" height="auto" alt="' .$displayList[9].'"></button>'.
'<button tabindex="0" class="col-3 gallery" type="submit" name="imageName" value="tile=11&mug='.$displayFiles[10].'&token='.$diceOrder[10].'&dice=' . $diceImages[10][0] . $diceImages[10][1] . $diceImages[10][2] . '"><img src="./ckimages/'.$displayFiles[10].'.jpg" width="100%" height="auto" alt="' .$displayList[10].'"></button>'.
'<button tabindex="0" class="col-3 gallery" type="submit" name="imageName" value="tile=12&mug='.$displayFiles[11].'&token='.$diceOrder[11].'&dice=' . $diceImages[11][0] . $diceImages[11][1] . $diceImages[11][2] . '"><img src="./ckimages/'.$displayFiles[11].'.jpg" width="100%" height="auto" alt="' .$displayList[11].'"></button>'.
'</div>'.
// display next 4 random shuffled dice
'<div class="row d-flex justify-content-center">'.
